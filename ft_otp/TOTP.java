...
public class TOTP {
    ...
    public static String generateTOTP(String key, String time,
        ...
        // Compliant with base [RFC
        // 4226](https://datatracker.ietf.org/doc/html/rfc4226) (HOTP)
        ...
        try {
            ...
            for (int i = 0; i < testTime.length; i++) {
                ...
                System.out.print("|  " + fmtTime + "  |  " + utcTime + "  | " +
                                 steps + " |");
                System.out.println(
                    generateTOTP(seed32, steps, "8", "HmacSHA256") +
                    "| SHA256 |");
                System.out.print("|  " + fmtTime + "  |  " + utcTime + "  | " +
                                 steps + " |");
                System.out.println(
                    generateTOTP(seed64, steps, "8", "HmacSHA512") +
                    "| SHA512 |");
